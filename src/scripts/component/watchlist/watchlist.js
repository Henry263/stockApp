        ...
        const eachtickerDiv = tickerwlArray.map((key, i) => {
            ...
            return(
                <div className="each-watclist">
                    ...
                    <div className="w-ticker-change-p inline-class-wl w-ticker-adjust">%({key.quote.changePercent*100})</div>
                    ...
                    <div className="w-ticker-volume inline-class-wl w-ticker-adjust">{this.formatAllnumber(key.quote.marketCap)}</div></div>
            );
